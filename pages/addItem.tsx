...
function addItem({}: Props) {
  ...
  const mintNft = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
        ...
        const receipt = await transaction.receipt; // transaction receipt
        const tokenId = await transaction.id; // id of the nft minted
        const nft = await transaction.data(); // (optional) fetch details of minted nft
