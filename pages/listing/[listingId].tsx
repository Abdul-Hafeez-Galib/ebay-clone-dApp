        ...
        <main className="max-w-6xl mx-auto p-2 flex flex-col lg:flex-row space-y-10 space-x-5 pr-10">
            ...
            <section className="flex-1 space-y-5 pb-20 lg:pb-0">
              ...
              <div className="grid grid-cols-2">
                ...
                <p>
                  {listing.type === ListingType.Direct ? "Direct Listing" : "Auction Lisitng"}
                </p>
                ...
                <button onClick={buyNft} className="col-start-2 mt-2 bg-blue-600 font-bold
              ...
              <div className="grid grid-cols-2 space-y-2 items-center justify-end">
                ...
                />
                <button onClick={createBidOrOffer} className="bg-red-600 font-bold
                 text-white rounded-full w-44 py-4 px-10">
